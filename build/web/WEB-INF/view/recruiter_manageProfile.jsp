...
<html>
    <head>
        ...
        <link href="css/recruiter_manageProfile.css" rel="stylesheet" />    
    </head> 
    <body>
        ...
        <div id="side_bar" >
            ...
            <ul id="recruiter_menu">
                ...
                <!--link to build my resume --> 
                <!--                <li id ="link_myProfile" class="link_text">
                                    <a id="myProfile" href="#">Manage My Profile</a>
                                </li>-->
        ...
        <div id="content_bg" >
            <div id = "search_jobResult">
                <!--Manage my profile--> 
                <p id="myCreatedJobList" style="color: grey"><b>Manage my Profile</b></p>
                ...
                <div id="oneSeekerResult"  class="jobs">
                    <ul id="oneJob" class="jobList">
                        ...
                        <!--profile form start -->
                        <form  id="createJobs" action="recruiterProfile" method="post">
                            <ul>

                                <!--Input first name here-->
                                <li class="content_li" >
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="company_name" value="${recruiter.companyName}"/>     
                                </li>
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="address" value="${recruiter.address}"/>     
                                </li>


                                <!--Input phsone Number here-->
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="phoneNumber" value="${recruiter.phone}"/>     
                                </li>


                                <!--select company description here-->

                                <li class="content_li" >
                                    <p class="jobDetails_label">
                                        <span>Compnay Description</span>
                                    </p>
                                </li>  
                                <br>

                                <li  class="content_li" >
                                    <textarea id="jobdesc" rows="20" cols="50"" id="lable_selfDesc" class="user_input" name="companyDesc">${recruiter.description}</textarea>
                                </li>
                                <c:if test="${!empty requestScope.invalidRecruiterProfile}">
