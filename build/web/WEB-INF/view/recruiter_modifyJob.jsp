    ...
    <body>
            ...
            <div id="r_functions">
                <ul>
                    ...
                    <li id ="link_createJobCate" class="link_text">
                        <a id="createJobCate" href="recruiter_createCategory">Create a Job Category</a>
                    </li>
        ...
        <div id="content_bg" >
            <div id = "search_jobResult">
                <!--Title--> 
                <p id="myCreatedJobList" style="color: grey"><b>Modify Job</b></p>
                ...
                <div id="oneSeekerResult"  class="jobs">
                    <ul id="oneJob" class="jobList">
                        ...
                        <form  id="createJobs" action="recruiterModifyJob" method="post">
                            <ul>
                                ...
                                <input type="hidden" class="inputs" name="jobId" value="${job.jobId}"/>

                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="jobName" value="${job.jobName}"/>     
                                </li>
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="jobLocation" value="${job.address}"/>     
                                </li>
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="jobPosition" value="${job.position}"/>     
                                </li>
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="salary" value="${job.salary}"/>     
                                </li>
                                ...
                                <li id="jobLocation" class="link_text">
                                    <input type="text" class="inputs" name="keywords" value="${job.relKeywords}"/>     
                                </li>
                                ...
                                <li class="content_li">
                                    <select id="typeOfJob" class = "selections" name = "jobType" value="${job.jobType}">
                                ...
                                <li class="content_li">
                                    <select id="jobCompens" class = "selections">
                                ...
                                <!--Button save here -->
                                <li  class="content_li" >
                                    <textarea name ="description" id="jobdesc" rows="20" cols="50" id="lable_selfDesc" class="user_input"> ${job.description}</textarea>
                                </li>
